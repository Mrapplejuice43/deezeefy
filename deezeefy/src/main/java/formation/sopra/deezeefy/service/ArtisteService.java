...
public class ArtisteService {
	...
	public Artiste findByLoginAndPassword(String login, String password) {

		Optional<Artiste> newArtiste = artisteRepository.findByLoginAndPassword(login, password);

		if (newArtiste.isEmpty()) {
			throw new CompteException("admin absent ");

		}

		return newArtiste.get();
	}
